...
exports.ConnectionServiceClient = void 0;
 ...
 */
const gapicConfig = require("./connection_service_client_config.json");
...
class ConnectionServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            clusterPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/regions/{region}/clusters/{cluster}'),
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.bigquery.connection.v1.ConnectionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        for (const methodName of connectionServiceStubMethods) {
            const callPromise = this.connectionServiceStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    clusterPath(project, region, cluster) {
     ...
     */
    matchRegionFromClusterName(clusterName) {
...
//# sourceMappingURL=connection_service_client.js.map